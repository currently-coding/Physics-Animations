...
class Animate3DFunction(ThreeDScene):
    def construct(self):
        ...
        def lenght_animation(l1, l2):
            ...
            self.add(progress_line1, progress_line2, distance_label1, distance_label2, point)
        ...
        self.play(time_tracker.animate.increment_value(2 * PI), run_time=1, rate_func=linear)

        lenght_animation(3, 2)
